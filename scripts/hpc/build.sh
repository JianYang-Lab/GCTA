...
module load gcc/9.4.0 ninja intelmkl gsl

# Generate cmake
cmake -DCMAKE_BUILD_TYPE=Release -DCMAKE_INSTALL_PREFIX=${CWD}/build/Release/installed/usr -G Ninja -B build/Release -S .
